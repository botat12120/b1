...
const url = ['https://telegra.ph/file/a69f4e9cf361408214a3b.jpg', 
  ...
  const randomImage = tips[Math.floor(Math.random() * tips.length)];
   var messa = await prepareWAMessageMedia({ image: { url:'https://telegra.ph/file/d01b28f3678a2a62a7d53.jpg' } }, { upload: conn.waUploadToServer });
